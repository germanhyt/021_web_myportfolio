...
function ButtonWhatsapp() {
  const whatsappUrl =
    "https://api.whatsapp.com/send?phone=51915976931&text=Hola%20qu%C3%A9%20tal%2C%20vengo%20de%20tu%20web...%F0%9F%93%B2%F0%9F%91%8D%F0%9F%8C%90";
    ...
    <div className="relative hidden sm:flex z-50">
      <div className="fixed bottom-8 right-8 transition-all duration-500 hover:scale-110">
        <a
          href={whatsappUrl}
          target="__blank"
          onClick={() => trackOutboundLink(whatsappUrl, "floating_whatsapp_btn")}
